...
if L then
    ...
    L["Pet Battle Dungeon"] = "Pet Battle Dungeon"
    L["Mythic +"] = "Mythic +"
    ...
    L["Raiding With Leashes"] = "Raiding With Leashes"
    ...
    L["Search mounts..."] = "Search pets..."
    L["Pet Collection Log"] = "Pet Collection Log"
    ...
    L["Pet Collection"] = "Pet Collection"
    L["Mount Collection"] = "Pet Collection"  -- Fallback for old reference
    L["If enabled, collected mounts will not be shown in the list at all. Requires UI reload."] = "If enabled, collected pets will not be shown in the list at all. Requires UI reload."
    L["Hide Collected Mounts"] = "Hide Collected Mounts"
    L["Mounts Per Row"] = "Pets Per Row"
    L["Mount Collection Log Settings"] = "Pet Collection Log Settings"
    L["Set the number of mounts to display per row in the mount grid. Requires UI reload."] = "Set the number of pets to display per row in the pet grid. Requires UI reload."
    L["Set the progress bar colors to be shown when all mounts are collected"] = "Set the progress bar colors to be shown when all pets are collected"
    ...
    -- Missing Zone Names
    L["The Azure Span"] = "The Azure Span"
    L["Thaldraszus"] = "Thaldraszus"
    L["Ohn'ahran Plains"] = "Ohn'ahran Plains"
    L["Zuldazar"] = "Zuldazar"
    L["The Ringing Deeps"] = "The Ringing Deeps"
    L["Multiple Zones"] = "Multiple Zones"
    L["Isle of Dorn"] = "Isle of Dorn"
    L["Hallowfall"] = "Hallowfall"
    L["Azj-Kahet"] = "Azj-Kahet"
    L["Multiple Continents"] = "Multiple Continents"
    
    -- Additional missing zone names
    L["The Waking Shores"] = "The Waking Shores"
    L["Zaralek Cavern"] = "Zaralek Cavern"
    ...
    L["Antoran Wastes"] = "Antoran Wastes"
    L["Eredath"] = "Eredath"
    L["Krokuun"] = "Krokuun"
    ...
    L["Uldum"] = "Uldum"
    L["Twilight Highlands"] = "Twilight Highlands"
    L["Deepholm"] = "Deepholm"
    ...
    L["Alliance Territory"] = "Alliance Territory"
    L["Horde Territory"] = "Horde Territory"
    L["Darkmoon Island"] = "Darkmoon Island"
